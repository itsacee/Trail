...
// Two players can share the same start time only when lesson length and focus
// match. A different start that overlaps is still blocked.
...
// True when this start is full, overlaps another time, or has a different
// focus. Old bookings without a saved focus stay exclusive for safety.
export function slotBlocked(booked, timeLabel, mins, focus) {
