...
export const SCHEDULE = {
  ...
  1: { times: WEEKDAY, location: "delcity" },
  2: { times: WEEKDAY, location: "delcity" },
  3: { times: WEEKDAY, location: "delcity" },
  4: { times: WEEKDAY, location: "delcity" },
  5: { times: WEEKDAY, location: "delcity" },
