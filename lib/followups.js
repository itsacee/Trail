...
//      Four singles are $320; the month is $280. Only after the hour lesson,
...
//
// Every send is recorded in followups.json so a re-run can't email twice.
// These go out through Resend, same as the booking confirmations.
// The field address is never included.
...
export function membershipPitchMail(item, origin) {
  ...
  return {
    subject: `Keep the work going — 4 lessons for $280`,
    html: shell(
      `Want the same time next week?`,
      [
        `${hi}hope ${who}'s lesson on <strong style="color:#ffffff;">${when}</strong> went well.`,
        `If you want to keep this going you've got two ways: book another single for $80, or start a month.`,
        `<strong style="color:#ffffff;">Four singles are $320. A month of four hour lessons is $280</strong> — so you save $40, and nothing auto-renews. You pay once and you're done.`,
      ],
      "Start a month",
      link
    ),
    text:
      ...
      `If you want to keep this going you've got two ways: book another single for $80, or start a month.\n\n` +
      `Four singles are $320. A month of four hour lessons is $280 — so you save $40, and nothing auto-renews. You pay once and you're done.\n\n` +
      `Start a month: ${link}\n\n` +
