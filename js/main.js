...
function updateMemberCheckout() {
  ...
  const slotTitle = slotStep?.querySelector(".booking__step-title");
  ...
  if (slotTitle) {
    slotTitle.innerHTML = isMem
      ? '<span class="booking__step-num">1</span> Pick your first lesson <span class="booking__step-hint">Weeknights 5&ndash;9 PM &middot; Weekends 9 AM&ndash;7 PM</span>'
  ...
  if (bookTitle) {
    bookTitle.textContent = isMem ? "Join & Pick Your First Lesson." : "Pick a Day. Grab Your Spot.";
  }
  if (bookLead) {
    bookLead.textContent = isMem
      ? "Pick your first lesson today. After you pay, sign in with your email to book the other 3 — one per week, when you know you can make it."
