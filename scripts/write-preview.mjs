  ...
  <section class="section" id="programs">
    <div class="container">
      ...
      <div class="grid grid--3 pricing">
        ...
        <a class="price-card price-card--featured reveal" href="/book.html?type=membership" data-membership-purchase>
          ...
          <p class="membership-availability" data-membership-availability>Checking membership availability…</p>
